...
const mapDispatchToProps = function (dispatch) {
    return {
        ...
        editCompany : function (id, name, phoneManager, emailManager, nameManager, address) {
            dispatch(editCompany(id, name, phoneManager, emailManager, nameManager, address))
        }
    }
};
...
class CompanyEditor extends React.Component {
    ...
    SubmitEdit() {
        CompanyEditorService.putCompany(this.props.match.params.id, {
                ...
                if(res.status === '200') {
                    window.location.replace('/management/companies')
                } else {
                    this.setState({message : 'Edit unsuccess'})
                }
        })
    }
    ...
    deleteArea(e) {
        ...
        areaService.deleteArea(this.state.id,this.state.areas[key].id).then(res => {
            ...
            <div>
                ...
                <div style={{ background: '#fff', padding: 24, minHeight: 280 }}>
                    ...
                    <Table striped>
                        ...
                        <Link to={'/management/companies'}><Button onClick={this.SubmitEdit.bind(this)}>SUBMIT</Button></Link>
                    </div>
                </div>
            </div>
        )
